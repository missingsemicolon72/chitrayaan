 ...
 * marked `config.public`. Registered at the root so it also covers unknown routes (401, not 404,
 * so route existence is not revealed) and every plugin registered afterwards.
 *
